...
public class OfficialUploadFiller
{
	...
	{     
		...
		//client.getHostConfiguration().setProxy("xxxx", xxx);我用了代理了，你可以不用这个
		...
		NameValuePair username = new NameValuePair("username", "wubq1987521@163.com");     
		NameValuePair password = new NameValuePair("password", "xxxx");     
