...
/**
 *  This class sends post requests to the official registry and upload a biobrick for the user.
 */
public class OfficialUploadPoster
{
	...
	/**
	 * Login to the igem.org, uses the username and the password of the user. 
	 * @return If or not succeeded in logging in.  
	 */
	...
	/**
	 * After logging in get the next available part name. 
	 * @return The next avaliable part name.
	 */
	...
	/**
	 * Get the part name region available for the user. 
	 * @return A String[] which length is 2, specifying the min and the max of the
	 * part name available.  
	 */
	...
	/**
	 * Post and create a new part in the registry by the name specified. 
	 * @param part_name The part_name, can be any String between the min and the max. 
	 * @param bbkUpload The Strings wrapped in the BbkUpload instance to be uploaded. 
	 * @return The part_id generated by the registry.
	 */
	...
	/** Modify the primary info by the String in the BbkUpload instance.  */
	...
	/** Modify the sequence info by the String in the BbkUpload instance.  */
	...
	/** Modify the category info by the String in the BbkUpload instance.  */
	...
	/** Modify the parameter info by the String in the BbkUpload instance.  */
	...
	/** Modify the feture info by the String in the BbkUpload instance.  */
	...
	/**
	 * The comparator to sort the categories. When posting, the newly posted item's 
	 * id is set to 999, the previously posted need to be posted in sorted order along
	 * with the newest one.
	 */
	...
	/**
	 * The comparator to sort the parameters. When posting, the newly posted item's 
	 * id is set to 999, the previously posted need to be posted in sorted order along
	 * with the newest one.
	 */
	...
	/** 
	 * Testing the functions in OfficialUploadPoster, not write in the class Testing to avoid the imports.
	 */
	...
	{	
		...
		bbkUpload.author = "SJTU-Software";
		...
		modifyPrimaryInfo(bbkUpload);
		modifyParameters(bbkUpload);
		modifyCategories(bbkUpload);
		modifySequence(bbkUpload);
