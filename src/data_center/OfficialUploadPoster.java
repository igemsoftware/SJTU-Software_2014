...
/** This class sends post requests to the official registry and upload a biobrick
 * for the user.  */
public class OfficialUploadPoster
{
	...
	/** Testing the functions in OfficialUploadPoster, not write in the class Testing
